...
namespace MyStuff11net
{
    public class ShellBrowseForFolderDialog
    {
        ...
        {
            public InitializedEventArgs(IntPtr hwnd1)
            {
                hwnd = hwnd1;
            }
        ...
        {
            public IUnknownEventArgs(IntPtr hwnd1, IntPtr iunknown1)
            {
                hwnd = hwnd1;
                iunknown = iunknown1;
            }
        ...
        {
            public SelChangedEventArgs(IntPtr hwnd1, IntPtr pidl1)
            {
                hwnd = hwnd1;
                pidl = pidl1;
            }
        ...
        {
            public ValidateFailedEventArgs(IntPtr hwnd1, string invalidSel1)
            {
                hwnd = hwnd1;
                invalidSel = invalidSel1;
            }
            public readonly IntPtr hwnd;
        ...
        public void ShowDialog()
        {
            ...
            ShellApi.BROWSEINFO bi = new ShellApi.BROWSEINFO
            {
                ...
                lParam = 0,
                lpfn = new ShellApi.BrowseCallbackProc(MyBrowseCallbackProc)
            };
            ...
            isf.GetDisplayNameOf(pidlSelected, (uint)ShellApi.SHGNO.SHGDN_NORMAL | (uint)ShellApi.SHGNO.SHGDN_FORPARSING, out ShellApi.STRRET ptrDisplayName);

            ShellApi.StrRetToBSTR(ref ptrDisplayName, pidlRoot, out string sDisplay);
            m_FullName = sDisplay;
