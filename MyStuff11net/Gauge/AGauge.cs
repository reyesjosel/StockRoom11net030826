...
namespace MyStuff11net
{
    ...
    public partial class AGauge : Control
    {
        ...
        private Color[] m_RangeColor = { Color.LightGreen, Color.Red, Color.FromKnownColor(KnownColor.Control),
        ...
        public class ValueInRangeChangedEventArgs : EventArgs
        {
            ...
            public ValueInRangeChangedEventArgs(Int32 valueInRange1)
            {
                valueInRange = valueInRange1;
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (drawGaugeBackground)
            {
                ...
                #endregion"Draw ranges"

                ggr.SetClip(ClientRectangle);

                #region"Draw the Arc Base."
                ...
                #endregion"Draw the Arc Base."

                #region"Draw text, line"
                ...
                #endregion"Draw the Cap text"

                #endregion "Draw Gauge Background"
            }
