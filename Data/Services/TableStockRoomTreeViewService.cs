...
public partial interface ITableStockRoomTreeViewService
{
    ...
    Task<IEnumerable<Table_StockRoom_TreeView>> GetFullTreeAsync(CancellationToken cancellationToken = default);
    Task<IEnumerable<Table_StockRoom_TreeView>> GetSubTreeAsync(int rootId, CancellationToken cancellationToken = default);
...
public partial class TableStockRoomTreeViewService : ITableStockRoomTreeViewService
{
    ...
    public TableStockRoomTreeViewService(IUnitOfWork unitOfWork)
    {
    ...
    public async Task<DataTable> LoadStockRoomsTreeViewDataTableAsync()
    {
        var items = await _unitOfWork.TableStockRoomTreeViewRepository.GetAllAsync();
        return items.ToDataTable();
    }

    public async Task<BindingList<Table_StockRoom_TreeView>> LoadStockRoomsTreeViewAsync(int? count = null)
    {
        var items = await _unitOfWork.TableStockRoomTreeViewRepository.GetAllAsync(count: count);
