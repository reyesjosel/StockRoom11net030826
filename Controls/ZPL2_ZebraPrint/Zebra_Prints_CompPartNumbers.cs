    ...
    public partial class Zebra_Prints_CompPartNumbers : Form
    {
        ...
        string Contruct_Labels()
        {
            ...
            if (isEncodeCode)
            {
                ...
                {
                    if (Enum.IsDefined(typeof(Utilities.EncodeCode), Convert.ToInt32(BarCodeData.Substring(0, 3), cultures)))
                        Code = "" + (Utilities.EncodeCode)Convert.ToInt32(BarCodeData.Substring(0, 3), cultures);
                    else
                    {
