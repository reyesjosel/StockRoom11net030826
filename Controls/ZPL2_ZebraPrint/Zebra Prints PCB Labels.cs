    ...
    public partial class Zebra_Prints_PCBLabels : Form
    {
        ...
        private string Contruct_Labels()
        {
            ...
            if (isEncodeCode)
            {
                ...
                {
                    if (Enum.IsDefined(typeof(Utilities.EncodeCode), Convert.ToInt32(BarCodeData.Substring(0, 3))))
                        Code = "" + (Utilities.EncodeCode)Convert.ToInt32(BarCodeData.Substring(0, 3));
                    else
                    {
