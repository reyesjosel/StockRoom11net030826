...
namespace StockRoom11net.Controls
{
    public class Custom_Events_Args
    {
        ...
        */
            ...
            public LogFileMessageEventArgs(List<string> logFileMessage, DataGridViewRow logFileGridRow)
            {
                ...
                foreach (DataGridViewCell cell in logFileGridRow.Cells)
                {
                    ...
                    if (logFileMessage[index].Contains(cell.OwningColumn.Name))
                        builder.Append(Tags.TextColor(cellValue + "; ", Color.Red));
                    else
        ...
        {
            public CellDoubleClick_EventArgs(string information, string partNumberTag, Utilities.ProcessMode processInfor)
            {
            ...
            // Constructor.
            public CellDoubleClick_EventArgs(DataGridViewRow dataGridViewRow, Utilities.ProcessMode processInfor)
            {
            ...
            // Constructor.
            public CellDoubleClick_EventArgs(DataGridViewRow dataGridViewRow, Utilities.ProcessMode processInfor, string columnName)
            {
                DataGridViewRow = dataGridViewRow;
                // If Grouping is active.
                if (dataGridViewRow.DataBoundItem.GetType().Name == "GroupRow")
            ...
            /// </summary>
            public Utilities.ProcessMode ProcessInfor { get; private set; }
        ...
        public class Save_Requested_EventArgs : EventArgs
        {
            ...
            public Save_Requested_EventArgs(Utilities.NotificationEvents saveEvent, Table_StockRoom changeRow)
            {
                ...
                switch (saveEvent)
                {
                    ...
                    case Utilities.NotificationEvents.RowAdded:
                        {
                            break;
                        }
                    case Utilities.NotificationEvents.RowRemoved:
                        {
                            break;
                        }
            ...
            public Save_Requested_EventArgs(Utilities.NotificationEvents saveEvent, DepartmentInformation departmentInformation)
            {
                SaveEvent = saveEvent;
                DepartmentInformation = departmentInformation;
            }

            public Utilities.NotificationEvents SaveEvent;
