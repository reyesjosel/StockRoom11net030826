...
namespace StockRoom11net.Controls.OpenFileDialogExt
{

    public class OpenFileDialogExt : Component
    {
        #region Dll import
        ...
        public OpenFileDialogExt(DialogViewTypes dialogViewTypes)
        {
            m_IsWatching = false;
        ...
        public bool CheckFileExists
        {
            get
            {
                return OpenFileDialog.CheckFileExists;
            }
            set
            {
                OpenFileDialog.CheckFileExists = value;
            }
        }
        ...
        private void CheckActiveWindow()
        {
            lock (this)
            {
                ...
                if (listviewHandle != 0)
                {
                    SendMessage(listviewHandle, WM_COMMAND, (uint)m_DialogViewTypes, 0);
                }
            }
        }
    }
