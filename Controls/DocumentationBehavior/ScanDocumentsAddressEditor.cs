...
namespace StockRoom11net.Controls.DocumentationBehavior
{
    public partial class ScanDocumentsAddressEditor : Form
    {
        ...
        void ExtExplorer(string pathRootFolder)
        {
            ...
            using (FileSystemEnumerator.FileSystemEnumerator fse = new FileSystemEnumerator.FileSystemEnumerator(pathRootFolder,
                                                                        fileExtToMatch,
                                                                        true,
                                                                        true,
                                                                        500000))
        ...
        void UpDateCheckBoxUI()
        {
            ...
            foreach (KeyValuePair<string, int> extFound in ExtCountDict.OrderByDescending(ext => ext.Value))
            {
