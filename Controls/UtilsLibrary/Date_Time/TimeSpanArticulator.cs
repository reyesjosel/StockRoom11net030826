...
namespace StockRoom11net.Controls.UtilsLibrary.Date_Time
{
    [Flags]
    ...
    internal class TimeSpanAttribute : Attribute
    {
        ...
        /// on a given enum
        /// </summary>
        /// <param name="target">todo: describe target parameter on RetrieveAttribute</param>
        public static TimeSpanAttribute RetrieveAttribute(Enum target)
        {
            object[] attributes = target.GetType().GetField(target.ToString()).GetCustomAttributes(
    ...
    internal static class TimeSpanArticulator
    {
        ...
        internal class TemporalGrouping
        {
            ...
            {
                string result = Magnitude.ToString();

                result += " " + TimeSpanAttribute.RetrieveAttribute(Type).Name;
        ...
        /// </summary>
        /// <param name="groupings">todo: describe groupings parameter on Textify</param>
        private static string Textify(IList<TemporalGrouping> groupings)
        {
            ...
            {
                var groupingStr = groupings[i].ToString();
