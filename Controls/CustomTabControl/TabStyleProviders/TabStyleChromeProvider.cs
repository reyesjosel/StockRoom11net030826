    ...
    public class TabStyleChromeProvider : TabStyleProvider
    {
        ...
        public override void AddTabBorder(GraphicsPath path, Rectangle tabBounds)
        {
            ...
            switch (_TabControl.Alignment)
            {
                case TabAlignment.Top:
                    ...
                    path.AddCurve(new Drawing.Point[] {  new Drawing.Point(tabBounds.X, tabBounds.Bottom)
                    ...
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.Right - spread, tabBounds.Y)
                ...
                case TabAlignment.Bottom:
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.Right, tabBounds.Y)
                    ...
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.X + spread, tabBounds.Bottom)
                ...
                case TabAlignment.Left:
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.Right, tabBounds.Bottom)
                    ...
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.X, tabBounds.Y + spread)
                ...
                case TabAlignment.Right:
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.X, tabBounds.Y)
                    ...
                    path.AddCurve(new PointF[] {  new Drawing.Point(tabBounds.Right, tabBounds.Bottom - spread)
        ...
        protected override void DrawTabCloser(int index, Graphics graphics)
        {
            if (_ShowTabCloser)
            {
                ...
                if (closerRect.Contains(new Drawing.Point((int)_TabControl.MousePosition.X, (int)_TabControl.MousePosition.Y)))
                {
