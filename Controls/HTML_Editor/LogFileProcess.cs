...
namespace StockRoom11net.Controls
{
    public class LogFileProcess
    {
        ...
        private Utilities.HTMLFileTemple TempleToBeUse;
        ...
        public LogFileProcess(string logFilePath_Name, string templeFilePath_Name, Utilities.HTMLFileTemple templeToUse)
        {
        ...
        private void InitializeLogFile()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
             //           Utilities.On_StatusBarMessage(new StatusBarMessage_EventArgs("The LogFile temple was no founded. Error in System setting"));
                        return;
                    }
            ...
            //            Utilities.On_StatusBarMessage(new StatusBarMessage_EventArgs("The File will be Create in " + " " + directoryProject));
                    }

                    templeLogFile.CopyTo(FileProperties.ProjectFullPath, true);
            //        Utilities.On_StatusBarMessage(new StatusBarMessage_EventArgs("A new LogFile has been created, " + FileProperties.ProjectFullPath));
        ...
        public void Write_LogFile(LogFileMessageEventArgs e)
        {
            ...
            FileSystemExt.FileSystemExt.CallExecuteWithFailOver(FileProperties.ProjectFullPath, LogFileHTML);
        }
