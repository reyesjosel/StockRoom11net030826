...
namespace StockRoom11net.Controls.HTML_Editor
{
    ...
    public partial class Htmlwysiwyg : UserControl
    {
        ...
        /// </summary>
        [Description("Show the print button or not"),
        Category("Toolbar")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Description("Show the Ordered List button or not"),
        Category("Toolbar")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
