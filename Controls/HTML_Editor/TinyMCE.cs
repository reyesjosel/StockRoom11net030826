...
using System.Text;
using DoneButton_EventArgs = StockRoom11net.Controls.Custom_Events_Args.DoneButton_EventArgs;
...
namespace StockRoom11net.Controls.HTML_Editor
{
    ...
    public partial class TinyMCE : UserControl
    {
        ...
        //   public ChromiumWebBrowser webBrowserControl;
        ...
        public TinyMCE()
        {
            ...
            //       webBrowserControl = new ChromiumWebBrowser("www.google.com");
            //       Controls.Add(webBrowserControl);
            //       webBrowserControl.Dock = DockStyle.Fill;

            //        webBrowserControl.RegisterJsObject("winformObj", new JavaScriptInteractionObj(webBrowserControl, this));
        ...
        public TinyMCE(HTMLEditor htmlEditor)
        {
            InitializeComponent();
            ...
            //        string page = string.Format("{0}HTMLEmbeddedResources/html/WinformInteractionExample.html", GetAppLocation());
            //        webBrowserControl.Load(page);

            // webBrowserControl.ObjectForScripting = new ScriptManager(this);

            // if (!string.IsNullOrEmpty(Settings.Default.ApplicationDefaultHtmlPages))
            // {
            //Create a list of all possible editor temple....
            ...
            //      webBrowserControl.Url = new Uri(@"file:///" + @"C:\Users\Owner\Documents\ProductionManagement\Resources\tinymce\examples\full.html");
