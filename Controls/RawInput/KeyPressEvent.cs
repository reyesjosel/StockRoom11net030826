namespace StockRoom11net.Controls.RawInput
{
    public class KeyPressEvent
    {
        ...
        public string BarCodeDataRead;  // BarCode Scanner read data.
        public string ASCIIControlChar; // ASCII Control Character detected.
        public string VID;
        public string PID;
        public IntPtr DeviceKey;
