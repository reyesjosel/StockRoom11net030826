...
namespace StockRoom11net.Controls.EmployeeInformation
{
    public class DepartmentInformation
    {
        ...
        public DepartmentInformation()
        {
            try
            {
                ...
                DeptRights = Utilities.GetDict("AccessLevel:0;EditMode:0;EnableTreeViewSetting:0");

                DeptEditMode = Utilities.EditMode.View;
                DeptAccessLevel = Utilities.AccessLevel.User;
                ...
                string defaultDocumentsLocation = Path.Combine(Settings.Default.DataBaseAddress, "DataSheets");
        ...
        public Utilities.AccessLevel DeptAccessLevel
        {
            get
            {
                return (Utilities.AccessLevel)DeptRights["AccessLevel"];
            }
        ...
        public Utilities.EditMode DeptEditMode
        {
            get
            {
                return (Utilities.EditMode)DeptRights["EditMode"];
            }
        ...
        public bool IsViewMode
        {
            get
            {
                if ((Utilities.EditMode)DeptRights["EditMode"] == Utilities.EditMode.View)
                    return true;
        ...
        public bool IsEditMode
        {
            get
            {
                if ((Utilities.EditMode)DeptRights["EditMode"] == Utilities.EditMode.Edit)
                    return true;
        ...
        public bool IsDeleteMode
        {
            get
            {
                if ((Utilities.EditMode)DeptRights["EditMode"] == Utilities.EditMode.Delete)
                    return true;
        ...
        public bool IsAddMode
        {
            get
            {
                if ((Utilities.EditMode)DeptRights["EditMode"] == Utilities.EditMode.Add)
                    return true;
        ...
        void DocumentsAddressProcess(string documentsAddressSetting)
        {
            ...
            var defaulDocumentsLocation = "12345" + SpliterCharacter + "Private" + SpliterCharacter + "Description for default dataSheets location" + SpliterCharacter +
                                          Path.Combine(Settings.Default.DataBaseAddress, "DataSheets") + SpliterCharacter + "*.doc,*.docx,*.pdf";
        ...
        void ScanDocumentsAddressProcess(string scanDocumentsAddressSetting)
        {
            ...
            var defaulScanDocumentsLocation = "12345" + SpliterCharacter + "Private" + SpliterCharacter + "Description for default dataSheets location" +
                                                        SpliterCharacter + Path.Combine(Settings.Default.DataBaseAddress, "DataSheets") +
        ...
        public void SaveSetting()
        {
            ...
            DepartmentRow["AccessLevel"] = Utilities.GetString(DeptRights);
    ...
    public sealed class DeptSetting
    {
        ...
        public DeptSetting(DataGridViewAutoSizeColumnsMode autoSizeColumnsMode, Utilities.EditMode customEdit)
        {
