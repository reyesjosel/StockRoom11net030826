...
namespace StockRoom11net.Controls
{
    public class NodeProperties : INotifyPropertyChanged
    {
        ...
        public NodeProperties(Table_Base_TreeView item)
        {
            try
            {
                Index = item.Index;         //0
                ...
                Node_PDF = item.Node_PDF ?? "";                     //4
                Node_Picture = item.Node_Picture ?? "";             //5
        ...
        public NodePropertiesBackup(DataRowView nodeRowView)
        {
            ...
            {
                MessageBox.Show(new Form() { TopMost = true }, @"Found an error at " + MessageDebugPosition + " " + error.Message,
                                @"NodeProperties constructor has generated an error.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        */
        ...
        void InitializeNodeProperties(DataRow nodeDataRow)
        {
            try
            {
                Index = Utilities.IntParseFast(nodeDataRow["Index"].ToString());       //0
                ID = Utilities.IntParseFast(nodeDataRow["ID"].ToString());             //1
                ...
                ItemCount = Utilities.IntParseFast(nodeDataRow["ItemCount"].ToString());
        ...
        */
        ...
        public int MyFatherIs
        {
            get
            {
                if (_nodeRowView != null)
                {
                    ...
                    return Utilities.IntParseFast(_nodeRowView["MyFatherIs"].ToString());
                }
        ...
        public int MyGrandFatherIs
        {
            get
            {
                if (_nodeRowView != null)
                {
                    ...
                    return Utilities.IntParseFast(_nodeRowView["MyGrandFatherIs"].ToString());
                }
        ...
        public string AvailableDepartmentFilter
        {
            get
            {
                ...
                filter = filter.TrimEnd(" OR Properties LIKE '*".ToCharArray());
        ...
        public SortedDictionary<string, int> BOM_List
        {
            ...
            set
            {
                ...
                _nodeRowView["Properties"] = Utilities.GetString(_BOM_List);
            }
        }
        ...
        public void SaveProperties()
        {
            ...
            {
                NotificationEvent = Utilities.NotificationEvents.DataBaseUpDated,
