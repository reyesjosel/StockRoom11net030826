...
using DataGridViewMouseDownEventArgs = StockRoom11net.Controls.Custom_Events_Args.DataGridViewMouseDownEventArgs;
...
using Get_String = StockRoom11net.Controls.Utilities;
    ...
    public partial class DataGridViewExtended : UserControl
    {
        ...
        public object DataSource
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    MessageDebugPosition = "DataTable";
                    ...
                    if (isBindingSourceGeneric && isBindingSource)
                    {
                        _bindingSource = (BindingSource)value;
                ...
                {
                    MessageBox.Show(@"Error in DataSource property, " + error.Message, MessageDebugPosition,
		...
		*/
            ...
            catch (Exception error)
            {
                using (var form1 = new Form { TopMost = true })
                {
                    MessageBox.Show(form1, @"Message related to this error is " + error.Message +
                                                               @" at position " + MessageDebugPosition,
        ...
        void OnBindingSourceListChanged(object? sender, ListChangedEventArgs e)
        {
            ...
            {
                if (TableName.Contains("_TreeView") || TableName.Contains("Table_TimeLine"))
                {
                    // e.NewIndex is the VIEW position — not the entity's DB Index column.
                    // Cast through ITableBaseTreeView to get the real primary-key value.
        ...
        void _dataGridView_DataSourceChanged(object? sender, EventArgs e)
        {
            ...
            // After a datasource change the DataGridView internally resets all column SortModes
            // back to Automatic. Clear stale column-selection state so the next header click
            // goes through SelectColumn() (which calls SortCancel) rather than UnSelectColumn(),
        ...
        */
            ...
            if (countError == 0)
            {
                ...
                using (var form = new Form { TopMost = true })
                {
                    MessageBox.Show(form, @"Message related to this error is " + e.Exception.Message,
                                          @"DataGridViewExtended has generated an error at " + MessageDebugPosition,
                                          MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
        ...
        void DataGridViewSelectionChanged()
        {
            try
            {
                MessageDebugPosition = "DataGridViewSelectionChanged()";
		...
		*/
        ...
        void ContextMenuStripDataGridViewOpening(object? sender, CancelEventArgs e)
        {
            try
            {
                MessageDebugPosition = "Try and catch loop in Context_menu_strip_data_grid_view_opening.";
                ...
                MessageDebugPosition = "ColumnHeader right-Click.";
                if (_dataGridView.CurrentColumnActive == null)
                    return;
                ...
                MessageDebugPosition = "RowHeader right-Click.";
                ...
                MessageDebugPosition = "Cells right-Click.";
                if (_dataGridView.HitTestData.ColumnIndex > -1 & _dataGridView.HitTestData.RowIndex > -1)
                {
