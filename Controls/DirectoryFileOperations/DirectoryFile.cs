using StockRoom11net.Controls.UtilsLibrary.String;
using StockRoom11net.Properties;
using System.Text.RegularExpressions;



namespace StockRoom11net.Controls.DirectoryFileOperations
{
    public class DirectoryFile : IDisposable
    {
        ...
        /// </summary>
        /// <param name="projectFullAddress"></param>
        public DirectoryFile(string projectFullAddress, Utilities.HTMLFileTemple templeToUse)
        {
            try
            {
