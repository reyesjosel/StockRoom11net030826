...
namespace StockRoom11net.Controls.TabControl.Design
{
    public class FATabStripDesigner : ParentControlDesigner
    {
        ...
        {
            IDesignerHost host = (IDesignerHost)GetService(typeof(IDesignerHost));
            DesignerTransaction transaction = host.CreateTransaction("Remove TabStrip");
            changeService.OnComponentChanging(Control, null);
        ...
        public override ICollection AssociatedComponents
        {
            get
            {
                return (ICollection)Control.Items;
            }
        }
