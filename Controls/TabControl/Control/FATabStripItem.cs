...
namespace StockRoom11net.Controls.TabControl.Control
{
    ...
    public class FATabStripItem : Panel, IComponent, ICloneable, INotifyPropertyChanged
    {
        ...
        public FATabStripItem(FATabStrip displayControl) : this(string.Empty, displayControl)
        {
        }

        public FATabStripItem(string caption, FATabStrip displayControl)
        {
        ...
        private void UpdateText(string caption, FATabStrip displayControl)
        {
