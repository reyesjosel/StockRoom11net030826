namespace StockRoom11net.Controls
{
    public class Notification
    {
                            ...
                            string properties, string status)
        {
            ...
            NotifycationEvents = (Utilities.NotificationEvents)NotifycationEvent; // 4 notifycation.NotifycationEvents
        ...
        public Notification(object[] values)
        {
            ...
            NotifycationEvents = (Utilities.NotificationEvents)values[4];    // 4 notifycation.NotifycationEvents
        ...
        public Utilities.NotificationEvents NotifycationEvents;
