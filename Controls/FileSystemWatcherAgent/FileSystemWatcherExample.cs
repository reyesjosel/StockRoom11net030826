namespace StockRoom11net.Controls.FileSystemWatcherAgent
{
    class FileSystemWatcherExample : Form
    {
        ...
        private void SingleByteReadThread(string pathRootFolder)
        {
            while (true)
            {
                using (FileSystemEnumerator.FileSystemEnumerator fse = new FileSystemEnumerator.FileSystemEnumerator(
                                                                            pathRootFolder,
                                                                            "*.*",
                                                                            true,
                                                                            true,
