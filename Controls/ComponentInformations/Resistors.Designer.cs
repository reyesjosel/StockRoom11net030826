namespace StockRoom11net.Controls.ComponentInformations
{
    partial class Resistor
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel_Value = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            panel_Unid = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            panel_Tolerance = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            panel_Size = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            Package = new ComboBox();
            label_Size = new Label();
            panel_Power = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            Power = new ComboBox();
            ...
            grouper_BaseComponent.ForeColor = SystemColors.ControlText;
            grouper_BaseComponent.GroupTitle = "Resistor";
            ...
            Unid.TabIndex = 3;
            Unid.KeyUp += Any_KeyUp;
            Unid.Leave += Any_Leave;
            // 
            // Tolerance
            // 
            ...
            Tolerance.Text = "1";
            Tolerance.KeyUp += Any_KeyUp;
            Tolerance.Leave += Any_Leave;
            // 
            // Value
            // 
            ...
            Value.TabIndex = 1;
            Value.KeyUp += Any_KeyUp;
            Value.Leave += Any_Leave;
            // 
            // label_Tolerance
            // 
            ...
            Package.TabIndex = 4;
            Package.Text = "0402";
            Package.KeyUp += Any_KeyUp;
            Package.Leave += Any_Leave;
            // 
            // label_Size
            // 
            ...
            panel_Power.Location = new Point(455, 0);
            ...
            Power.TabIndex = 5;
            Power.Text = "1/8";
            Power.KeyUp += Any_KeyUp;
            Power.Leave += Any_Leave;
            // 
            // label_Power
            // 
        ...
        private System.Windows.Forms.Label label_Unid;
        ...
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel_Tolerance;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel_Value;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel_Size;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel_Unid;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel_Power;
    }
}
