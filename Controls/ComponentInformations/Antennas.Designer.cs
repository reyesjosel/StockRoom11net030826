namespace StockRoom11net.Controls.ComponentInformations
{
    partial class Antennas
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel3 = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            Value = new TextBox();
            label_Value = new Label();
            panel1 = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
            Unid = new ComboBox();
            label_Unid = new Label();
            panel2 = new CustomPanelDoubleBuffered.CustomPanelDoubleBuffered();
        ...
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel3;
        private TextBox Value;
        private Label label_Value;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel1;
        private ComboBox Unid;
        private Label label_Unid;
        private CustomPanelDoubleBuffered.CustomPanelDoubleBuffered panel2;
