...
{
    public partial class ManualsWarrantyCards : BaseComponent
    {
        ...
        public ManualsWarrantyCards()
        {
            InitializeComponent();
        }

        public ManualsWarrantyCards(ComponentInformation componentInformations)
        {
            InitializeComponent();
